...
def test_bn_back_flat():
    ...
    dx_num = numerical_gradient_array(lambda x: bn_layer.forward(random_inp), random_inp, random_output_gradient,h=eps)
    dbeta_num = numerical_gradient_array(lambda beta: bn_layer.forward(random_inp), beta, random_output_gradient,h=eps)
    dgamma_num = numerical_gradient_array(lambda gamma: bn_layer.forward(random_inp), gamma, random_output_gradient,h=eps)


    out = bn_layer.forward(random_inp)
